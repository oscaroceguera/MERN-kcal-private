...
test("[POST /meals] - Should create a new meal", async () => {
  ...
  const orderFoods = foods.sort();
  const orderFfoodsIDs = foodsIDs.sort();
  ...
  expect(orderFoods[0].toString()).toEqual(orderFfoodsIDs[0].toString());
  expect(orderFoods[1].toString()).toEqual(orderFfoodsIDs[1].toString());
  expect(orderFoods[2].toString()).toEqual(orderFfoodsIDs[2].toString());
});
